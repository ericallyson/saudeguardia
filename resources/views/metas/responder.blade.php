...
@section('content')
    <div class="bg-gradient-to-b from-slate-50 to-white/90 backdrop-blur shadow-2xl rounded-3xl p-6 md:p-10 space-y-8 border border-slate-100">
        ...
        @if ($showChart)
            ...
            @if ($metaChartAtual)
                <div class="bg-white/80 border border-slate-100 rounded-2xl p-6 md:p-7 space-y-4 shadow-sm">
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <span class="hidden md:inline-flex items-center rounded-full bg-slate-100 px-3 py-1 text-[11px] font-medium text-slate-600">
